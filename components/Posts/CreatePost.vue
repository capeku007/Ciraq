...
<div class="min-h-[76svh] bg-red-500 flex justify-center items-center">
  <div v-if="!showVideo" class="grid grid-rows-[1fr] min-h-[74svh] max-h-[74svh] overflow-hidden">
    <VideoRecorder @videoRecorded="handleVideoRecorded" />
  </div>

  <div v-if="showVideo" class="grid grid-rows-[1fr] min-h-[74svh] max-h-[74svh] overflow-hidden">
    <video class="rounded-lg" v-if="showVideo" :src="recordedVideoUrl" controls autoplay></video>
