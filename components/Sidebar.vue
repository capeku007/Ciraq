        ...
        <div class="flex flex-1 h-screen overflow-y-scroll">
          ...
          >
            ...
            <div class="flex flex-col h-screen">
                ...
                <div class="space-y-6">
                  ...
                  <div class="space-y-4">
                    ...
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        src="https://ui-avatars.com/api/?name=Someone&color=7F9CF5&background=EBF4FF"
                        alt="Someone"
                      />
                      <div class="overflow-hidden">
                        <h4
                    ...
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        src="https://ui-avatars.com/api/?name=Another-Person&color=7F9CF5&background=EBF4FF"
                        alt="Another Person"
                      />
                      <div class="overflow-hidden">
                        <h4
                    ...
                    <a href="#" class="flex items-start space-x-2 group">
                      <img
                        class="flex-shrink-0 object-cover w-12 h-12 rounded-full"
                        src="https://ui-avatars.com/api/?name=Another-Name&color=7F9CF5&background=EBF4FF"
                        alt="Another Name"
                      />
                      <div class="overflow-hidden">
                        <h4
              ...
              <!-- Panel footer -->
              <footer
                class="flex items-center justify-between flex-shrink-0 px-4 py-2 border-t dark:border-primary-darker"
              >
                <div class="text-sm">
                  View on
                  <a
