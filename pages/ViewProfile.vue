        ...
        <div class="w-full md:w-8/12 md:mx-2">
          ...
          <div class="bg-white p-3 shadow-sm rounded-sm">
            ...
            <div class="md:flex no-wrap md:-mx-2">
              ...
              <img class="rounded w-36 h-36" src="/assets/images/profile-img.jpg" alt="Extra large avatar"></div>
        ...
        <div class="w-full md:w-4/12 md:mx-2">
          ...
          <div class="bg-white p-3 hover:shadow">
            ...
            <div class="grid grid-cols-3">
              <div
                class="m-2 rounded-2xl text-center bg-emerald-100 text-black py-2 px-4"
              >
                <h1>Brand Design</h1>
              </div>
            </div>
